...
import 'dish_page_model.dart';
export 'dish_page_model.dart';

class DishPageWidget extends StatefulWidget {
  const DishPageWidget({Key? key}) : super(key: key);

  @override
  _DishPageWidgetState createState() => _DishPageWidgetState();
}

class _DishPageWidgetState extends State<DishPageWidget> {
  late DishPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DishPageModel());
  }

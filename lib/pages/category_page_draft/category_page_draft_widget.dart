...
class _CategoryPageDraftWidgetState extends State<CategoryPageDraftWidget> {
  late CategoryPageDraftModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CategoryPageDraftModel());
